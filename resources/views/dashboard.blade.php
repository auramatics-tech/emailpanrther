...
@section('content')
    ...
    <div class="row">
    <div class="card px-0 shadow-sm container-fluid col-3" bis_skin_checked="1">
        <div class="card-body pt-2" bis_skin_checked="1">
            <div class="d-flex align-items-center pt-1" bis_skin_checked="1">
                <label class="panel-title text-semibold my-0 fw-600">EE Queue Waiting</label>
            </div>
            <p class="mb-0">{{ $ee_stats['queues']['submit']['waiting'] }}</p>
        </div>
    </div>
    <div class="card px-0 shadow-sm container-fluid col-3" bis_skin_checked="1">
        <div class="card-body pt-2" bis_skin_checked="1">
            <div class="d-flex align-items-center pt-1" bis_skin_checked="1">
                <label class="panel-title text-semibold my-0 fw-600">EE Queue Active</label>
            </div>
            <p class="mb-0">{{ $ee_stats['queues']['submit']['active'] }}</p>
        </div>
    </div>
    <div class="card px-0 shadow-sm container-fluid col-3" bis_skin_checked="1">
        <div class="card-body pt-2" bis_skin_checked="1">
            <div class="d-flex align-items-center pt-1" bis_skin_checked="1">
                <label class="panel-title text-semibold my-0 fw-600">EE Queue Delayed</label>
            </div>
            <p class="mb-0">{{ $ee_stats['queues']['submit']['delayed'] }}</p>
        </div>
    </div>
</div>
<div class="row">
    <div class="card px-0 shadow-sm container-fluid col-3" bis_skin_checked="1">
        <div class="card-body pt-2" bis_skin_checked="1">
            <div class="d-flex align-items-center pt-1" bis_skin_checked="1">
                <label class="panel-title text-semibold my-0 fw-600">IMAP Webhook Queue Waiting</label>
            </div>
            <p class="mb-0">{{ $ee_stats['queues']['notify']['waiting'] }}</p>
        </div>
    </div>
    <div class="card px-0 shadow-sm container-fluid col-3" bis_skin_checked="1">
        <div class="card-body pt-2" bis_skin_checked="1">
            <div class="d-flex align-items-center pt-1" bis_skin_checked="1">
                <label class="panel-title text-semibold my-0 fw-600">IMAP Webhook Queue Active</label>
            </div>
            <p class="mb-0">{{ $ee_stats['queues']['notify']['active'] }}</p>
        </div>
    </div>
    <div class="card px-0 shadow-sm container-fluid col-3" bis_skin_checked="1">
        <div class="card-body pt-2" bis_skin_checked="1">
            <div class="d-flex align-items-center pt-1" bis_skin_checked="1">
                <label class="panel-title text-semibold my-0 fw-600">IMAP Webhook Queue Delayed</label>
            </div>
            <p class="mb-0">{{ $ee_stats['queues']['notify']['delayed'] }}</p>
        </div>
    </div>
</div>
    <h3 class="mt-5 mb-3">
