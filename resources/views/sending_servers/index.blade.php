...
<button type="button" class="btn btn-light sort-direction" data-popup="tooltip" title="{{ trans('messages.change_sort_direction') }}" role="button" class="btn btn-xs">
            ...
            <div class="text-end">
            <a target="_blank" href="{{url('sending_servers/error_logs')}}" role="button" class="btn btn-secondary">
                Error Logs
            </a>
        </div>
        &nbsp;
        &nbsp;
            @if (Auth::user()->customer->can('create', Acelle\Model\SendingServer::class))
                <div class="text-end">
                    <a href="{{ action('SendingServerController@create', ["type" => 'multi-smtp']) }}" role="button" class="btn btn-secondary">
                        <span class="material-symbols-rounded">add</span> New Multi SMTP Server
                    </a>
                </div>&nbsp;
                &nbsp;
                <div class="text-end">
                    <a href="{{ action('SendingServerController@create', ["type" => 'smtp']) }}" role="button" class="btn btn-secondary">
