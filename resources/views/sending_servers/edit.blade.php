    ...
    <div class="page-title">
        ...
        <h1>
            <div class="d-flex align-items-center">
                <span class="text-semibold me-3"><span class="material-symbols-rounded">edit</span>
                    {{ $server->name }}
                </span>
...
@section('content')
    ...
    <script>
        var AddNewServer = {
            popup: null,
            url: '{{ action('SendingServerController@new_multi_server', $server->uid) }}',
        ...
        $(function() {
            $('#AddNewServer').on('click', function(e) {
                e.preventDefault();
    
                AddNewServer.getPopup().load();
            });
        });
    </script>
