...
'menu' => 'domain_assignment',
])

@section('title', 'Domain Assignment')
...
<div class="page-title">
    ...
    <h1>
        <span class="text-semibold"><span class="material-symbols-rounded">format_list_bulleted</span> Domain Assignment</span>
    </h1>
</div>
...
@section('content')
<div class="listing-form" sort-url="{{ action('DomainAssignmentController@sort') }}" data-url="{{ action('DomainAssignmentController@listing') }}" per-page="{{ Acelle\Model\SendingServer::$itemsPerPage }}">
    <div class="d-flex top-list-controls top-sticky-content">
        ...
        &nbsp;
        <div class="text-end">
            <a href="{{ action('DomainAssignmentController@create') }}" role="button" class="btn btn-secondary">
                <span class="material-symbols-rounded">add</span> New Assignment
            </a>
        </div>
    </div>
...
<script>
    var DomainAssignmentIndex = {
        getList: function() {
            return makeList({
                url: '{{ action('DomainAssignmentController@listing') }}',
    ...
    $(function() {
        DomainAssignmentIndex.getList().load();
    });
</script>
@endsection