        ...
        <div class="addable-multiple-form">
            <div class="addable-multiple-container campaign-list-segments">
                ...
                @foreach ($campaign->getListsSegmentsGroups() as $index =>  $lists_segment_group)
                    ...
                    <?php $num++ ?>
                @endforeach
            <input type="checkbox" value="1" name="random_order" id="" @if(isset($campaign->random_order)  && $campaign->random_order) checked @endif>  Random Order
            <br>
        <br>
        <label for="">Server type</label>
        <br><br>
        <input type="radio" value="smtp" name="server_type" id="" @if(isset($campaign->server_type)  && $campaign->server_type == 'smtp') checked @endif>  SMTP&nbsp;&nbsp;
        <input type="radio" value="multi-smtp" name="server_type" id="" @if(isset($campaign->server_type)  && $campaign->server_type == 'multi-smtp') checked @endif>Multi SMTP   
