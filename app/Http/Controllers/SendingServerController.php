...
class SendingServerController extends Controller
{
    ...
    {
        // $this->attachNamecheap('businessvideos.website', '159.223.132.111');
    ...
    public function error_logs(Request $request)
    {
        ...
        $items = ConnectionLog::select('connection_logs.*', 'sending_servers.name', 'sending_servers.uid')
            ...
            ->orderby('connection_logs.created_at', 'desc')->paginate($per_page);
        return view('sending_servers.error_logs', compact('items'));
    }
}
