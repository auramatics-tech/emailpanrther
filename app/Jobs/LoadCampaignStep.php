...
class LoadCampaignStep implements ShouldQueue
{
    use Trackable;
    use Batchable;
    use Dispatchable;
     ...
     * @return void
     */
    public function __construct(Campaign $campaign, $type)
    {
    ...
    public function handle()
    {
        ...
        $this->campaign->prepareStep(function ($campaign, $subscriber, $server, $step, $variant) {
