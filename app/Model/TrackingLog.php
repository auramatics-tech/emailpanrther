...
class TrackingLog extends Model
{
    ...
    protected $fillable = ['email_id', 'campaign_id', 'message_id', 'runtime_message_id', 'subscriber_id', 'sending_server_id', 'customer_id', 'status', 'error', 'auto_trigger_id', 'sub_account_id', 'mail_list_id', 'campaign_step_id', 'campaign_variant_id', 'repeat'];
    ...
    public static function search($request, $campaign = null)
    {
        ...
        }elseif (isset($campaign) && is_array($campaign)) {
            $query = $query->whereIn('tracking_logs.campaign_id', $campaign);
        }
