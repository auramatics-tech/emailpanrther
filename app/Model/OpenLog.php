...
{
    protected $fillable = ['message_id', 'campaign_step_id', 'campaign_variant_id', 'conditional_step_id', 'runs_at', 'sent'];
    ...
    public static function createFromRequest($request)
    {
        ...
        $log->campaign_step_id = $tracking_log->campaign_step_id;
        $log->campaign_variant_id = $tracking_log->campaign_variant_id;
        try {
