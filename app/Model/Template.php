    ...
    public static function tags($list = null)
    {
        ...
        if (isset($list)) {
            foreach ($list->fields as $field) {
                if ($field->tag != 'EMAIL') {
                    // check if even single subscriber has the value
                    $filed_value = \Acelle\Model\SubscriberField::where('field_id', $field->id)->whereNotNull('value')->first();
                    if (isset($filed_value->id))
