...
Route::group(['middleware' => ['not_installed']], function () {
    ...
    Route::get('c/{subscriber}/unsubscribe/{message_id?}/{campaign_id?}', 'CampaignController@unsubscribe')->name('unsubscribeUrl');
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend', 'subscription']], function () {
    ...
    // Subscriber
    Route::get('lists/{list_uid}/subscribers/import2/run', 'SubscriberController@import2Run');
    ...
    Route::post('campaigns/{uid}/add_step', 'CampaignController@add_step');
    ...
    Route::post('campaigns/{uid}/delete_step', 'CampaignController@delete_step');
    Route::post('campaigns/{uid}/update_subject', 'CampaignController@update_subject');
    Route::post('campaigns/{uid}/update_content', 'CampaignController@update_content');
    Route::post('campaigns/{uid}/wait_for', 'CampaignController@wait_for');
    Route::post('campaigns/{uid}/save_settings', 'CampaignController@save_settings');
    Route::get('campaigns/{uid}/get_settings', 'CampaignController@campaign_step_settings');
    Route::post('campaigns/{uid}/remove_settings', 'CampaignController@remove_condition');
    Route::post('campaigns/{uid}/add_variant', 'CampaignController@add_variant');
    Route::post('campaigns/{uid}/delete_variant', 'CampaignController@delete_variant');
    Route::post('campaigns/{uid}/update_variant_status', 'CampaignController@update_variant_status');
    ...
    Route::get('domain_assignment/listing/{page?}', 'DomainAssignmentController@listing');
    Route::get('domain_assignment/sort', 'DomainAssignmentController@sort');
    Route::resource('domain_assignment', 'DomainAssignmentController');
    // Sending servers
    ...
    Route::post('sending_servers/update-sending-limit', 'SendingServerController@updatesendingLimit');


    Route::get('sending_servers/error_logs', 'SendingServerController@error_logs');
    ...
    Route::get('senders/dropbox_domain', 'SenderController@dropbox_domain');
...
Route::post('imap/webhook', 'CampaignController@imap_webhook');
Route::get('imap/mails', 'CampaignController@get_mails');
Route::get('smtp-test', 'TestingController@smtpTest');


Route::get('cohost', 'CampaignController@cohost_api');
Route::get('custom_imap', 'CampaignController@custom_imap');

//Proxies
Route::get('proxies/listing/{page?}', 'ProxiesController@listing');
Route::get('proxies/sort', 'ProxiesController@sort');
Route::resource('proxies', 'ProxiesController');
Route::get('proxies/delete/{proxy}', 'ProxiesController@destroy')->name('delete-proxy');
